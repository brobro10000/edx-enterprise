...
class TestSupportEnterpriseEnrollmentDataInjector(TestCase):
    ...
    def test_attaches_empty_list_when_no_enterprise_enrollments(self, mock_get_enrollments, mock_get_consents):
        ...
        result = step.run_filter(enrollments=enrollments, user=user)

        assert result['enrollments'][0]['enterprise_course_enrollments'] == []
    ...
    def test_attaches_enterprise_enrollments_to_matching_enrollment(
        ...
        entries = result['enrollments'][0]['enterprise_course_enrollments']
    ...
    def test_enrollment_without_matching_consent_has_none_consent(
        ...
        assert result['enrollments'][0]['enterprise_course_enrollments'][0]['data_sharing_consent'] is None
    ...
    def test_preserves_existing_enrollment_keys(self, mock_get_enrollments, mock_get_consents):
        ...
        assert result['enrollments'][0]['mode'] == 'audit'
        assert result['enrollments'][0]['enterprise_course_enrollments'] == []
